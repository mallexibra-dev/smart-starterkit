                        ...
                        {iconOptions.map((icon) => (
                          <SelectItem key={icon.value} value={icon.value}>
                            <div className="flex items-center space-x-2">
                              <span className="text-lg">{icon.label === icon.value ? icon.value.charAt(0).toUpperCase() : icon.value}</span>
                              {icon.label}
                            </div>
                          </SelectItem>
                        ))}
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormDescription>
                      Controls the order of categories (lower numbers appear first)
                    </FormDescription>
                    <FormMessage />
                  </FormItem>
                )}
