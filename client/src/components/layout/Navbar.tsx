...
export const Navbar = () => {
  ...
  return (
    <nav className="h-full w-80 bg-gradient-to-br from-purple-50 via-white to-purple-100 dark:from-purple-900/20 dark:via-gray-800 dark:to-purple-800/20 rounded-2xl border border-purple-200/50 dark:border-purple-700/30 flex flex-col shadow-xl backdrop-blur-sm">
      {/* Header Section */}
          ...
          <div className="space-y-3">
            ...
            <div className="space-y-1">
              <Link to="/">
                <Button 
                  variant="ghost" 
                  className={`w-full justify-start h-12 text-gray-700 dark:text-gray-300 hover:bg-purple-100 dark:hover:bg-purple-800/30 transition-all duration-200 px-3 rounded-xl group ${
                    isActive('/') 
                ...
                >
                  <Home className={`w-5 h-5 mr-3 transition-colors ${isActive('/') ? 'text-white' : 'text-purple-500 group-hover:text-purple-600'}`} />
                  Dashboard
                </Button>
              </Link>

              <Link to={"/analytics" as any}>
                <Button 
                  variant="ghost" 
                  className={`w-full justify-start h-12 text-gray-700 dark:text-gray-300 hover:bg-purple-100 dark:hover:bg-purple-800/30 transition-all duration-200 px-3 rounded-xl group ${
                    isActive('/analytics') 
                ...
                >
                  <BarChart3 className={`w-5 h-5 mr-3 transition-colors ${isActive('/analytics') ? 'text-white' : 'text-purple-500 group-hover:text-purple-600'}`} />
                  Analytics
                </Button>
              </Link>
              ...
              <Link to={"/users" as any}>
                ...
                >
                  <Users className={`w-5 h-5 mr-3 transition-colors ${isActive('/users') ? 'text-white' : 'text-purple-500 group-hover:text-purple-600'}`} />
                  Users
                </Button>
              </Link>
            </div>
      ...
      {/* Footer Section */}
      <div className="p-4 space-y-1 bg-gradient-to-t from-purple-50 to-transparent dark:from-purple-900/10 dark:to-transparent rounded-b-2xl">
        <Link to={"/settings" as any}>
          ...
          >
            <Settings className={`w-5 h-5 mr-3 transition-colors ${isActive('/settings') ? 'text-white' : 'text-purple-500 group-hover:text-purple-600'}`} />
            Settings
          </Button>
        </Link>
        ...
        <Link to={"/help" as any}>
          ...
          >
            <HelpCircle className={`w-5 h-5 mr-3 transition-colors ${isActive('/help') ? 'text-white' : 'text-purple-500 group-hover:text-purple-600'}`} />
            Help & Support
          </Button>
        </Link>
      </div>
